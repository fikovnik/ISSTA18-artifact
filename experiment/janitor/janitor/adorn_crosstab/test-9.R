...
test_that("adorn_crosstab", {
    ...
    expect_equal(janitor:::adorn_crosstab(dat = ., denom = "all", digits = 0), structure(list(cyl = c("4", "6", "8"), `0` = c("9%  (3)", 
        "12%  (4)", "38% (12)"), `1` = c("25% (8)", "9% (3)", "6% (2)")), class = "data.frame", row.names = c(NA, -3L)))
})
