...
test_that("search_matrix_position", {
    dataframe <- structure(list(subject = 1:100, initial = c("ph", "pf", "kf", "og", "mk", "ml", "ni", "ji", "nh", "nb", 
    ...
    expect_equal(dfexplore:::search_matrix_position(dataframe = dataframe), 9L)
})
