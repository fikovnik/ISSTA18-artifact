...
test_that("RiverBlockChart", {
    ...
    expect_equal(rivervis:::RiverBlockChart(site = B.sitehm$Site, river = B.sitehm$River, distance = B.sitehm$Distance, value = B.sitehm[4:9], 
        arrangement = c(1, 1, 2, 2), block.col = fivecolours, mar = 0.15, site.ofs = 1, site.cex = 0.7, rvr.order = c("Rock", 
            "Killymoon-Claggan", "Ballinderry", "Ballymully", "Kildress", "Kingsmill", "Lissan", "Tulnacross")), NULL)
})
