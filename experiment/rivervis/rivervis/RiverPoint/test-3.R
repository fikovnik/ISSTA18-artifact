...
test_that("RiverPoint", {
    ...
    expect_equal(rivervis:::RiverPoint(site = B.sitenh4n$Site, river = B.sitenh4n$River, distance = B.sitenh4n$Distance, 
        value = B.sitenh4n$NH4N_Autumn, riverlayout = riverlayout, type = "o", pt.col = "#FF3931FF", pt.bg = "pink", pt.pch = 21, 
        lbl.shw = TRUE), NULL)
})
