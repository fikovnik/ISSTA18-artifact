...
test_that("jpsq.benftest", {
    ...
    expect_equal(BenfordTests:::jpsq.benftest(x = X), structure(list(statistic = structure(0.527212515370093, names = "J_stat_squ"), 
        p.value = 0.3241, method = "JP-Square Correlation Statistic Test for Benford Distribution", data.name = "X"), class = "htest"))
})
