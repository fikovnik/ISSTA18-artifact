...
test_that("usq.benftest", {
    ...
    expect_equal(BenfordTests:::usq.benftest(x = X), structure(list(statistic = structure(0.0625376191391229, names = "U_square"), 
        p.value = 0.4847, method = "Freedman-Watson U-squared Test for Benford Distribution", data.name = "X"), class = "htest"))
})
