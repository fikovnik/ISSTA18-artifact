...
test_that("mdist.benftest", {
    ...
    expect_equal(BenfordTests:::mdist.benftest(x = X), structure(list(statistic = structure(0.451819876142342, names = "m_star"), 
        p.value = 0.6421, method = "Chebyshev Distance Test for Benford Distribution", data.name = "X"), class = "htest"))
})
