...
test_that("meandigit.benftest", {
    ...
    expect_equal(BenfordTests:::meandigit.benftest(x = X), structure(list(statistic = structure(0.00723717303871965, names = "a_star"), 
        p.value = 0.941711599277272, method = "Judge-Schechter Normed Deviation Test for Benford Distribution", data.name = "X"), 
        class = "htest"))
})
