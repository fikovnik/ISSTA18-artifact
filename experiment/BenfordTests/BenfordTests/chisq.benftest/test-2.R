...
test_that("chisq.benftest", {
    ...
    expect_equal(BenfordTests:::chisq.benftest(x = X, pvalmethod = "simulate"), structure(list(statistic = structure(5.99320809682959, 
        names = "chisq"), p.value = 0.6401, method = "Chi-Square Test for Benford Distribution", data.name = "X"), class = "htest"))
})
