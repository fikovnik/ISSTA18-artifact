...
test_that("crunchFillPage", {
    expect_equal(crunchy:::crunchFillPage(), structure(list(NULL, NULL, list(structure(list(name = "head", attribs = list(), 
        children = list(structure(list(name = "style", attribs = list(type = "text/css"), children = list("html, body { width: 100%; height: 100%; overflow: hidden; }", 
            "body { padding: 0px; margin: 0; }")), class = "shiny.tag"))), class = "shiny.tag"), structure(list(name = "head", 
        attribs = list(), children = list(structure(list(name = "link", attribs = list(rel = "stylesheet", type = "text/css", 
            href = "https://app.crunch.io/styles.css"), children = list()), class = "shiny.tag"), structure(list(name = "style", 
        ...
        class = "shiny.tag"))), class = c("shiny.tag.list", "list"), html_dependencies = list(structure(list(name = "bootstrap", 
