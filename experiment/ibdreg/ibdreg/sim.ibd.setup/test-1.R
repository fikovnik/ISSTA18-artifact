...
test_that("sim.ibd.setup", {
    ...
    expect_equal(ibdreg:::sim.ibd.setup(ped = ped, x.linked = x.linked), structure(list(person = 1:7, father = c(0L, 0L, 
        ...
        1, 1, 1, 1, 1, 1), a2 = c(1, 1, 1, 1, 1, 1, 1), a2.orig = c(2, 2, 2, 2, 2, 2, 2), chrom1 = structure(c(1, 7, 3, 0, 
        5, 0, 0), .Dim = c(7L, 1L), class = "model.matrix"), chrom2 = structure(c(2, 8, 4, 0, 6, 0, 0), .Dim = c(7L, 1L), 
