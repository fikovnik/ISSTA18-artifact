...
test_that("vcov.biglm", {
    ...
    object <- structure(list(call = biglm(ff, chunk1), qr = structure(list(D = c(31, 1.637533565667, 0.158482336758735), 
        ...
        class = "biglm")
    expect_equal(biglm:::vcov.biglm(object = object), structure(c(0.639663613873954, 0.0207935388649163, -0.16006212356148, 
        0.0207935388649163, 0.00562659199596149, -0.00813051158628854, -0.16006212356148, -0.00813051158628854, 0.0417945117424326), 
